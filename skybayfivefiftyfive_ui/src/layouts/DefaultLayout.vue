...
-->>
				...
				<a-menu-item>
					<router-link to="/inFlightServices">
						<span class="label">In Flight Services</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/rewardPrograms">
						<span class="label">Reward Programs</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/loungeAccesss">
						<span class="label">Lounge Accesss</span>
					</router-link>
				</a-menu-item>
