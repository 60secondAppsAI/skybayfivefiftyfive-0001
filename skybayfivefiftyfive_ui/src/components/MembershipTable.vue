...
<template>
  ...
  <base-input label="PointsAccumulated" type="text" placeholder="Enter PointsAccumulated" v-model="membershipToAdd.pointsAccumulated"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'pointsAccumulated',
          visible: true,
          scopedSlots: { customRender: 'pointsAccumulated' },
          sorter: true
          //sorter: (a, b) => a.pointsAccumulated - b.pointsAccumulated,
          //sorter: (a, b) => a.pointsAccumulated.localeCompare(b.pointsAccumulated),
        },
      ],
      pagination: {
        current: 1,
